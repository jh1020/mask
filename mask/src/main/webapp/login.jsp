...
<body>
    <div id="con">
    <div id="login">
    <div id="login_form" action="LoginAction.jsp" method="post"><!--로그인 폼-->
    <form>
        ...
        <input type="text" placeholder="아이디를 입력" class="size" id="id">
        ...
        <input type="password" placeholder="비밀번호를 입력" class="size" id="pw">
        <!-- <input type="submit" value="확인"> -->
        </label>
